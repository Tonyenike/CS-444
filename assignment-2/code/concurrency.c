...
int main() 
{
    ...
    //Create philosphers
    pthread_create(&thread_id1, NULL, eat, buffer); 
    pthread_create(&thread_id2, NULL, eat, buffer); 
    pthread_create(&thread_id3, NULL, eat, buffer);     
    pthread_create(&thread_id4, NULL, eat, buffer);
    pthread_create(&thread_id5, NULL, eat, buffer); 
